...
from src.earlylife.src.encoder_blocks import Block
from src.earlylife.src.lr_schedulers import CosineWarmupScheduler
...
class FinetuneNanoEncoder(BaseNanoEncoder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.decoder_finetune = nn.Linear(self.hparams["d_model"], 1)
    ...
    def standard_step(
        ...
        ## Mean pooling version
        # decoded_output = self.decoder_finetune(x.mean(dim=1)).view(-1)
