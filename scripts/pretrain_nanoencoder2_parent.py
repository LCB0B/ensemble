...
from src.datamodule2 import ParentPretrainCausalGridDataModule  # noqa: E402
from src.encoder_nano_risk import ParentPretrainNanoEncoder  # noqa: E402
...
if __name__ == "__main__":
    ...
    run_id = (
        get_wandb_runid(FPATH.TB_LOGS / hparams["experiment_name"]) + "-pretrain-parent"
    )
    ...
    dm = ParentPretrainCausalGridDataModule(
        dir_path=FPATH.DATA / hparams["dir_path"],
        sources=sources,
    ...
    # Model
    model = ParentPretrainNanoEncoder(**hparams)
