...
from src.tabular_models import objective_MLP
...
def main(hparams: DictConfig) -> None:
    ...
    if remaining_trials <= 0:
        ...
        print(
            f"Starting optimization with {remaining_trials} remaining trials out of {n_trials}."
        )

    # Optimization
    objective_with_params_set = lambda trial: objective_MLP(  # noqa: E731
        trial,
