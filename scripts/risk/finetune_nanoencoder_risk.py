...
if __name__ == "__main__":
    ...
    run_id = f"{get_wandb_runid(FPATH.TB_LOGS / hparams['experiment_name'])}-{hparams['dir_path']}-{hparams['outcome']['train'].split('_')[-2]}"
    seed_everything(73)
    ...
    model = RiskPredictionFinetuneNanoEncoder(**hparams)
