...
from src.datamodule2_new import PredictFinetuneLifeLDM
...
@hydra.main(
    ...
    config_name="hparams_destiny_finetune2.yaml",
    version_base=None,
)
def main(hparams: DictConfig):
    ...
    if hparams.auto_ntokens:
        auto_ntokens(
            trainer, model, dm, init_val=200_000, steps_per_trial=50, max_trials=4
        )
